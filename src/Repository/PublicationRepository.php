...
class PublicationRepository extends ServiceEntityRepository
{
    ...
    public function translations(Publication $publication): array { if(!$publication->getGroupeTraductionId())return[$publication];return $this->findBy(['groupeTraductionId'=>$publication->getGroupeTraductionId(),'statut'=>PublicationStatus::PUBLIE],['langue'=>'ASC']); }
}
