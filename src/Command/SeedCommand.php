...
{
    public function __construct(private EntityManagerInterface $em,private UserRepository $users,private ThemeRepository $themes,private PublicationRepository $publications,private LanguageRepository $languages){parent::__construct();}
